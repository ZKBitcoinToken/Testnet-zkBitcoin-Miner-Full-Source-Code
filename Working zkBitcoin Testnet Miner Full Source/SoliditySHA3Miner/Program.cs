            ...
            try
            {
                ...
                else
                {
                    var web3Interface = new NetworkInterface.Web3Interface(Config.web3api, Config.contractAddress, Config.minerAddress, Config.privateKey, Config.gasToMine,
                                                                          ...
                                                                          Config.gasLimit, Config.gasApiURL, Config.gasApiPath, Config.NFTApiURL, Config.NFTApiPath, Config.NFTApiPathID, Config.UsePayMaster, Config.ERC20Addresses, Config.gasApiMultiplier, Config.MaxZKBTCperMint, Config.MinZKBTCperMint, Config.HowManyBlocksAWAYFromAdjustmentToSendMinimumZKBTC, Config.gasApiOffset, Config.gasApiMax);
